...
if ($prevTimestamp === 0) {
    $lastVisitMsg = 'Bienvenido a su primera vez';
} else {
    $lastVisitMsg = 'Bienvenido, su última visita fue el '
        . date('d/m/Y H:i:s', $prevTimestamp) . '.';
}
...
<h1>Películas</h1>
<p style="color:blueviolet"><?= htmlspecialchars($lastVisitMsg) ?></p>
